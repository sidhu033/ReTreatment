...
import com.gamsys.ui.widgets.custom_fab.FloatingActionButton;
import com.gamsys.ui.widgets.custom_fab.FloatingActionMenu;
import com.gamsys.ui.widgets.custom_fab.SubActionButton;
import com.gamsys.services.BluetoothLeService;
import com.gamsys.services.RedoxerDeviceService;
import com.gamsys.ui.fragments.DashboardFragment;
import com.gamsys.ui.adapters.HomeFragmentPagerAdapter;
                        ...
                        if (command == (byte) 0xCC) {
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    mDashboardFragament.startOrResumeTreatment();
                                }
                            }, 30 * 1000);
                        }
                    }
        ...
        if (tvHideScreen != null) {
            tvHideScreen.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    preferenceHelper.putIsLogin(false);
                    startActivity(new Intent(HomeActivity.this, TreatmentLogsAdapter.class));
                }
            });
