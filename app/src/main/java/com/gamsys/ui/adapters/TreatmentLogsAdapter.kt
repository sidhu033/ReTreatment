...
class TreatmentLogsAdapter(val items: ArrayList<Logs>, val activity: Activity) : RecyclerView.Adapter<TreatmentLogsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val cursorOnTreatmentLog: Logs= items.get(position)
