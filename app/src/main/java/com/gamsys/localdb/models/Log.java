...
public Log(Date treatmentStartTimeStamp, int leftHandDiastolic, int leftHandSystolic, int leftHandPulse, int rightHandSystolic, int rightHandDiastolic, int rightHandPulse)
{
    ...
    public Log(Date s, String i, String toString, String string, String parseInt, String s1){
        this.treatmentStartTimeStamp = treatmentStartTimeStamp;
        this.leftHandSystolic = leftHandSystolic;
